...
using GeometryGeneration.GeneratorBase.Interfaces;
...
{
    public class BezierCurveGenerationGenerator : IGeometryGenerator<BezierCurveGenerationParameters>
    {
        ...
        public bool Validate(BezierCurveGenerationParameters settings)
        {
            return true;
        }

        private void Handle(GeometryModel<BezierCurveGenerationParameters> model)
        {
